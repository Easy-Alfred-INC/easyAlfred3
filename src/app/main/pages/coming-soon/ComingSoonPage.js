						...
						<Card className="w-full ">
							<CardContent className="flex flex-col items-left justify-left p-32">
								...
								<Typography variant="subtitle1" className="text-left w-full" color="textSecondary">
									...
									to set your itinerary. For immediate questions, call now. We're excited to get to know you.
								</Typography>
								<br/>
								<Typography  variant="subtitle1" className="text-left w-full" color="textSecondary">
								...
								<br/>
								<Typography  variant="subtitle1"  className="text-left w-full" color="textSecondary">
									3) Your Alfred will call you at the scheduled time. Please ensure you are available to speak.
								</Typography>
								<br/>
								<Typography  variant="subtitle1"  className="text-left w-full" color="textSecondary">
									4) Whether you're booking for tomorrow or 6 months from tomorrow, we work to ensure your services and trip are perfect for you!
								</Typography>

								<br/>
								<Typography variant="h6" className="text-center mb-16">
									Rest easy! Easy Alfred is here to help! 
								</Typography>
